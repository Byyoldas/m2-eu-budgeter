...
use erc_budget_lib::domain::rate_data::{CountryRate, FlightBand, RateData, RateVersion};
...
fn make_rate_data() -> RateData {
    let version = RateVersion {
        ...
        flight_bands: vec![
            FlightBand {
                band_id: "F-01".to_string(),
                label: "400-600 km".to_string(),
                min_km: 400,
                max_km: 600,
                cost_eur: 340,
            },
            FlightBand {
                band_id: "F-02".to_string(),
                label: "601-1600 km".to_string(),
                min_km: 601,
                max_km: 1600,
                cost_eur: 365,
            },
            FlightBand {
                band_id: "F-03".to_string(),
                label: "1601-2500 km".to_string(),
                min_km: 1601,
                max_km: 2500,
                cost_eur: 429,
            },
            FlightBand {
                band_id: "F-04".to_string(),
                label: "2501-3500 km".to_string(),
                min_km: 2501,
                max_km: 3500,
                cost_eur: 541,
            },
            FlightBand {
                band_id: "F-05".to_string(),
                label: "3501-4500 km".to_string(),
                min_km: 3501,
                max_km: 4500,
                cost_eur: 743,
            },
            FlightBand {
                band_id: "F-06".to_string(),
                label: "4501-6000 km".to_string(),
                min_km: 4501,
                max_km: 6000,
                cost_eur: 857,
            },
            FlightBand {
                band_id: "F-07".to_string(),
                label: "6001-7500 km".to_string(),
                min_km: 6001,
                max_km: 7500,
                cost_eur: 1021,
            },
            FlightBand {
                band_id: "F-08".to_string(),
                label: "7501-10000 km".to_string(),
                min_km: 7501,
                max_km: 10000,
                cost_eur: 1250,
            },
            FlightBand {
                band_id: "F-09".to_string(),
                label: "10001+ km".to_string(),
                min_km: 10001,
                max_km: 999999,
                cost_eur: 1595,
            },
        ...
        country_rates: vec![
            CountryRate {
                ...
                accommodation_eur: 195,
                subsistence_eur: 50,
            },
            CountryRate {
                country_code: "AT".to_string(),
                country_name: "Austria".to_string(),
                accommodation_eur: 158,
                subsistence_eur: 131,
            },
            CountryRate {
                country_code: "FR".to_string(),
                country_name: "France".to_string(),
                accommodation_eur: 212,
                subsistence_eur: 127,
            },
            CountryRate {
                country_code: "TR".to_string(),
                country_name: "Turkey".to_string(),
                accommodation_eur: 165,
                subsistence_eur: 55,
            },
            CountryRate {
                country_code: "GB".to_string(),
                country_name: "UK".to_string(),
                accommodation_eur: 209,
                subsistence_eur: 125,
            },
            CountryRate {
                country_code: "US".to_string(),
                country_name: "USA".to_string(),
                accommodation_eur: 200,
                subsistence_eur: 80,
            },
            CountryRate {
                country_code: "OTHER".to_string(),
                country_name: "Other".to_string(),
                accommodation_eur: 120,
                subsistence_eur: 40,
            },
        ],
    };
...
fn test_it01_equipment_detail_capped_flag() {
    ...
    let laptop = summary
        .equipment_detail
        .iter()
        .find(|e| e.name == "Laptop")
        .unwrap();
    let recorder = summary
        .equipment_detail
        .iter()
        .find(|e| e.name == "Audio Recorder")
        .unwrap();
...
fn test_it01_travel_vienna_conference() {
    ...
    let vienna = summary
        .trip_detail
        .iter()
        .find(|t| t.name == "Vienna Conference")
        .unwrap();
...
fn test_it01_c1_total_is_india_plus_vienna() {
    ...
    let summary = calculate_budget_summary(&project, &rate_data).unwrap();
    assert_eq!(
        summary.category_c1_total.round_dp(2),
        dec!(8908.00) + dec!(6015.00)
    );
}
...
fn test_it01_wp_budgets_travel_lands_in_correct_wp() {
    ...
    let wp1 = summary
        .wp_budgets
        .iter()
        .find(|w| w.work_package_id == 1)
        .unwrap();
    let wp2 = summary
        .wp_budgets
        .iter()
        .find(|w| w.work_package_id == 2)
        .unwrap();
...
fn test_it04_flat_amount_trip() {
    ...
    let flat_trip = Trip {
        ...
        trip_type: TripType::FlatAmount {
            flat_amount_per_instance_eur: dec!(2000),
        },
        number_of_instances: 3,
        work_package_ids: vec![1],
    };
...
fn test_it06_personnel_wp_allocation_multi_year_multi_inflation() {
    ...
    assert_eq!(
        wp1.personnel_eur + wp2.personnel_eur,
        summary.category_a_total
    );
    ...
    for role in &summary.role_detail {
        ...
        assert_eq!(
            breakdown_sum, role.total_cost_eur,
            "role {} WP breakdown must sum to its total cost",
            role.role_label
        );
    }
}
