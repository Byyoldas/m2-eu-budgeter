//! Centralised error types shared by the ERC Budget and ERC Execution applications.
//!
...
impl ValidationErrors {
    ...
    /// Not currently called internally, but kept as public API surface for callers.
    #[allow(dead_code)]
